...
function Github() {
  ...
  return (
    <div className="h-screen w-screen min-h-screen flex items-center justify-center">
      <div className="h-screen w-screen bg-gray-800 text-white p-8 rounded-lg shadow-lg text-center">
        <img
          src={data.avatar_url}
