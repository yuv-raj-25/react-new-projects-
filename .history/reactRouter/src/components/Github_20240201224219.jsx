...
function Github() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center">
      <div className="h-screen w-screen bg-gray-800 text-white p-8 rounded-lg shadow-lg text-center transition-transform transform hover:scale-105">
        <img
          src={data.avatar_url}
        ...
        />
        <h2 className="text-3xl font-bold mb-2 hover:text-blue-500 transition-colors">
          {data.name}
        </h2>
